...
const Toolbar: React.FC<ToolbarProps> = ({
  ...
  return (
    <div className="bg-white/80 dark:bg-slate-700/50 backdrop-blur-sm border-b border-slate-200 dark:border-slate-600/50 p-2 flex flex-col sm:flex-row items-center gap-2 sticky top-0 z-20">
